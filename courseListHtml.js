...
let Programing_container = document.querySelector(".Programing");
let graphic_design = document.querySelector(".graphic_design");
let music = document.querySelector(".music");
let mathemetics = document.querySelector(".mathemetics");
let bussines = document.querySelector(".bussines");
let science = document.querySelector(".science");

let ProgramingCoursesListHtmlDiv = 1;

function coursesListHtmlDiv(subject) {
  let courseList = course
    ...
    .map((v, i) => {
      return `
  <div class="ourcourse-start">
  <img src=${v.image} alt="js">
  <div class="about-course">
      <p>${v.title}<p>
          <p1>Updated ${v.courseUpdated}</p1>
     <div class="stars">
...
Programing_container.innerHTML = coursesListHtmlDiv("Programming");

graphic_design.innerHTML = coursesListHtmlDiv("GraphicDesign");

music.innerHTML = coursesListHtmlDiv("Music");

mathemetics.innerHTML = coursesListHtmlDiv("Mathematics");

bussines.innerHTML = coursesListHtmlDiv("Business");

science.innerHTML = coursesListHtmlDiv("Science");
